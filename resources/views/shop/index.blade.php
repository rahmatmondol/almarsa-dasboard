                ...
                <div class="card-body flex flex-col p-6">
                    ...
                    <div class="card-text h-full space-y-4">
                        <div class="input-area">
                            ...
                            <input id="title" name="title" type="text" value="{{ $shop->title ?? '' }}"
                                class="form-control" placeholder="title">
                        </div>
                        <div class="input-area">
                            <label for="description" class="form-label">Description</label>
                            <textarea name="description" id="description" rows="5" class="form-control" placeholder="Description">{{ $shop->description ?? '' }}</textarea>
                        </div>
                        <div class="input-area image_area">
                            ...
                            <div class="mt-4 relative preview-conteiner">
                                @if ($shop && $shop->icon)
                                    <img class="preview" src="{{ $shop->icon }}" style="max-width: 200px;">
                                @else
                        ...
                        <div class="input-area image_area">
                            ...
                            <div class="mt-4 relative preview-conteiner">
                                @if ($shop && $shop->image)
                                    <img class="preview" src="{{ $shop->image }}" style="max-width: 200px;">
                                @else
                                    <img class="preview" style="max-width: 200px; display: none;">
                                @endif
                                <button type="button" style="display: none;"
        ...
        <div class="card xl:col-span-2">
            <div class="card-body flex flex-col p-6">
                <header class="flex mb-5 items-center border-b border-slate-100 dark:border-slate-700 pb-5 -mx-6 px-6">
                    <div class="flex-1">
                        <div class="card-title text-slate-900 dark:text-white">Shop category list</div>
                    </div>
                </header>
    ...
    <script>
        ...
        $(document).ready(function($) {
            ...
            $(document).on('click', '.list-edit', function(e) {
                e.preventDefault();
                let id = $(this).data('id');
                let list = shopLists.find(item => item.id == id);
                if (list) {
