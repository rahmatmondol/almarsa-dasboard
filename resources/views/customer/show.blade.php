    ...
    <div class="py-8 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8">
                <div class="flex items-center space-x-6">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100 mt-1">Customer since {{ \Carbon\Carbon::parse($customer->created_at)->format('F Y') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-3 divide-x divide-gray-200 -mt-px">
                ...
                <div class="p-6 text-center">
                    <p class="text-2xl font-bold text-gray-900">${{ number_format($customer->orders->sum('grand_total'), 2) }}</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <h2 class="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    <svg class="w-5 h-5 mr-2 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center">
                        ...
                        <span class="text-gray-900">{{ \Carbon\Carbon::parse($customer->created_at)->format('M d, Y') }}</span>
                    </div>
                    <div class="flex items-center">
                        <span class="text-gray-500 w-24">Last Updated:</span>
                        <span class="text-gray-900">{{ \Carbon\Carbon::parse($customer->updated_at)->format('M d, Y') }}</span>
                    </div>
                    <div class="flex items-center">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('order.show', $order->id) }}" class="text-indigo-600 hover:text-indigo-900">View Details</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
